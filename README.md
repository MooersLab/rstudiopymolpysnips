...
The images generated by **PyMOL** can be stored in the one **Rmarkdown** file as opposed to having dozens of script and images files sequestered in dozens of subfolders.
